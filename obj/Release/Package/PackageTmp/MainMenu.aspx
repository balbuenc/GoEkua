<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MainMenu.aspx.cs" Inherits="GoWebForms.MainMenu" %>
            ...
            <div class="container-fluid" id="MainContainer">
                ...
                <div class="page-header  encabezado">
                    <div class="container-fluid">
                        <asp:Panel runat="server" DefaultButton="FacturasBtn" Height="250px">
                            <div class="row">
                                <div class="col-4 font-weight-bold">
                                    <asp:Button ID="FacturasBtn" runat="server" Text="Facturas" PostBackUrl="~/dte.aspx" />
                                </div>
                                <div class="col-4 font-weight-bold">
                                    <asp:Button ID="NotasCreditoBtn" runat="server" Text="Nota de Credito" />
                                </div>
                                <div class="col-6">
                                </div>
                            </div>
